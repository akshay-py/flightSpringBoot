...
public class FlightController {
	...
	public String findFlights(@RequestParam("from") String from, @RequestParam("to") String to, @DateTimeFormat(pattern = "MM-dd-yyyy") @RequestParam("departureDate") Date departureDate, ModelMap modelMap) {
